      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-4 md:mb-0">
            <h2 className="text-4xl font-extrabold text-purple-800 transition duration-300 hover:text-purple-500">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            {[
              ...
              <Link
                key={index}
                to={item.to}
                className="flex items-center gap-2 text-purple-800 text-lg font-medium transition hover:text-purple-500"
              >
                <span>{item.icon}</span>
