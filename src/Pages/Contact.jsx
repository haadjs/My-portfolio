    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          {/* Contact Information */}
          <div
            className="bg-white/5 p-6 sm:p-8 rounded-xl backdrop-blur-sm space-y-6"
            data-aos="fade-right"
          >
            ...
            <p className="text-gray-300 mb-6">
              ...
              ideas, or opportunities to work together.
            </p>
          ...
          >
            {isSubmitted ? (
              <div className="bg-white/10 p-6 sm:p-8 rounded-xl flex flex-col items-center justify-center space-y-4 min-h-[350px]">
        ...
        <div className="mt-12 sm:mt-16 text-center" data-aos="fade-up">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-2xl">
            <a
